...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            artifactId = "sqldelight-pgtextsearch"
            groupId = project.group.toString()
            version = project.version.toString()

            pom {
                name.set("SQLDelight PgTextSearch Module")
                description.set("SQLDelight module for pg_textsearch support")
                url.set("https://github.com/griffio/sqldelight-pgtextsearch-module-app")
                ...
                scm {
                    connection.set("scm:git:git://github.com/griffio/sqldelight-pgtextsearch-module-app.git")
                    developerConnection.set("scm:git:ssh://github.com/griffio/sqldelight-pgtextsearch-module-app.git")
                    url.set("https://github.com/griffio/sqldelight-pgtextsearch-module-app")
                }
            }
        }
...
jreleaser {
    gitRootSearch = true
    project {
        description = "SQLDelight module for pgtextsearch support"
